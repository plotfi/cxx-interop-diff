...
extension NSArray {
  ...
  @available(iOS 4.0, *)
  func enumerateObjects(options opts: Int = [], using block: (Any, Int, UnsafeMutablePointer<ObjCBool>) -> Void)
  @available(iOS 4.0, *)
  @available(swift, obsoleted: 3, renamed: "enumerateObjects(options:using:)")
  func enumerateObjectsWithOptions(_ opts: Int = [], usingBlock block: (Any, Int, UnsafeMutablePointer<ObjCBool>) -> Void)
  @available(iOS 4.0, *)
  func enumerateObjects(at s: IndexSet, options opts: Int = [], using block: (Any, Int, UnsafeMutablePointer<ObjCBool>) -> Void)
  @available(iOS 4.0, *)
  @available(swift, obsoleted: 3, renamed: "enumerateObjects(at:options:using:)")
  func enumerateObjectsAtIndexes(_ s: IndexSet, options opts: Int = [], usingBlock block: (Any, Int, UnsafeMutablePointer<ObjCBool>) -> Void)
  @available(iOS 4.0, *)
  ...
  @available(iOS 4.0, *)
  func indexOfObject(options opts: Int = [], passingTest predicate: (Any, Int, UnsafeMutablePointer<ObjCBool>) -> Bool) -> Int
  @available(iOS 4.0, *)
  @available(swift, obsoleted: 3, renamed: "indexOfObject(options:passingTest:)")
  func indexOfObjectWithOptions(_ opts: Int = [], passingTest predicate: (Any, Int, UnsafeMutablePointer<ObjCBool>) -> Bool) -> Int
  @available(iOS 4.0, *)
  func indexOfObject(at s: IndexSet, options opts: Int = [], passingTest predicate: (Any, Int, UnsafeMutablePointer<ObjCBool>) -> Bool) -> Int
  @available(iOS 4.0, *)
  @available(swift, obsoleted: 3, renamed: "indexOfObject(at:options:passingTest:)")
  func indexOfObjectAtIndexes(_ s: IndexSet, options opts: Int = [], passingTest predicate: (Any, Int, UnsafeMutablePointer<ObjCBool>) -> Bool) -> Int
  @available(iOS 4.0, *)
  ...
  @available(iOS 4.0, *)
  func indexesOfObjects(options opts: Int = [], passingTest predicate: (Any, Int, UnsafeMutablePointer<ObjCBool>) -> Bool) -> IndexSet
  @available(iOS 4.0, *)
  @available(swift, obsoleted: 3, renamed: "indexesOfObjects(options:passingTest:)")
  func indexesOfObjectsWithOptions(_ opts: Int = [], passingTest predicate: (Any, Int, UnsafeMutablePointer<ObjCBool>) -> Bool) -> IndexSet
  @available(iOS 4.0, *)
  func indexesOfObjects(at s: IndexSet, options opts: Int = [], passingTest predicate: (Any, Int, UnsafeMutablePointer<ObjCBool>) -> Bool) -> IndexSet
  @available(iOS 4.0, *)
  @available(swift, obsoleted: 3, renamed: "indexesOfObjects(at:options:passingTest:)")
  func indexesOfObjectsAtIndexes(_ s: IndexSet, options opts: Int = [], passingTest predicate: (Any, Int, UnsafeMutablePointer<ObjCBool>) -> Bool) -> IndexSet
  @available(iOS 4.0, *)
  ...
  @available(iOS 4.0, *)
  func sortedArray(options opts: Int = [], usingComparator cmptr: (Any, Any) -> ComparisonResult) -> [Any]
  @available(iOS 4.0, *)
  @available(swift, obsoleted: 3, renamed: "sortedArray(options:usingComparator:)")
  func sortedArrayWithOptions(_ opts: Int = [], usingComparator cmptr: (Any, Any) -> ComparisonResult) -> [Any]
  @available(iOS 4.0, *)
  func index(of obj: Any, inSortedRange r: NSRange, options opts: Int = [], usingComparator cmp: (Any, Any) -> ComparisonResult) -> Int
  @available(iOS 4.0, *)
  @available(swift, obsoleted: 3, renamed: "index(of:inSortedRange:options:usingComparator:)")
  func indexOfObject(_ obj: Any, inSortedRange r: NSRange, options opts: Int = [], usingComparator cmp: (Any, Any) -> ComparisonResult) -> Int
}
...
extension NSArray {
  func difference(from other: [Any], withOptions options: Int = [], usingEquivalenceTest block: (Any, Any) -> Bool) -> CollectionDifference<Any>
  @available(swift, obsoleted: 3, renamed: "difference(from:withOptions:usingEquivalenceTest:)")
  func differenceFromArray(_ other: [Any], withOptions options: Int = [], usingEquivalenceTest block: (Any, Any) -> Bool) -> CollectionDifference<Any>
  func difference(from other: [Any], withOptions options: Int = []) -> CollectionDifference<Any>
  @available(swift, obsoleted: 3, renamed: "difference(from:withOptions:)")
  func differenceFromArray(_ other: [Any], withOptions options: Int = []) -> CollectionDifference<Any>
...
extension NSMutableArray {
  ...
  @available(iOS 4.0, *)
  func sort(options opts: Int = [], usingComparator cmptr: (Any, Any) -> ComparisonResult)
  @available(iOS 4.0, *)
  @available(swift, obsoleted: 3, renamed: "sort(options:usingComparator:)")
  func sortWithOptions(_ opts: Int = [], usingComparator cmptr: (Any, Any) -> ComparisonResult)
}
extension NSMutableArray {
